...
@section('contents')
    <div class="row my-5">
            ...
            <div>
                ...
                <table class="table table-hover table-bordered results">
                    ...
                    <tr>
                        ...
                        <th class="col-md-4 col-xs-4">Registration Number</th>
                    ...
                    @if($users->count()>0)
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="text-uppercase">{{$user->regNo}}</td>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{route('verifyStudent',[$user->id])}}" class="text-success">Verify</a>
                                    @endif
                                </td>
                                <td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content alert alert-danger" role="alert" >
                                                ...
                                                <div class="modal-footer p-0">
                                                    ...
                                                    <a href="{{route('deleteStudent',['delete'=>$user->id])}}" class="btn btn-light text-danger p-1"  style="font-size: 14px">Remove</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
        ...
        <div class="col col-md-2" style="border-left:3px solid black">
            <ul>
                <li><a href="{{route('slogs')}}">Students Activities Log</a> </li>
            </ul>
        </div>
    </div>
@endsection
